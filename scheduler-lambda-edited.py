...
config = {
    'tag': 'schedule',
    'exclude': [''],
    'default': '{"mon": {"start": 7, "stop": 16},"tue": {"start": 7, "stop": 16},"wed": {"start": 7, "stop": 16},"thu": {"start": 7, "stop": 16},"fri": {"start": 7, "stop": 16},"sat": {"start": 7, "stop": 3},"sun": {"start": 8, "stop": 10}}'
}
